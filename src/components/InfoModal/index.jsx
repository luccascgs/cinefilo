import { Container, Overlay } from "../overlay";
import { Modal, Colaborador } from "./style";

export default function InfoModal({ setIsOpen }) {
  return (
    <Container>
      ...
      <Modal>
        ...
        <p>
          Tudo começou com uma ideia de jogo de mímica, que então foi moldada
          até nosso projeto final: Um jogo de adivinhação de filmes, inspirado
          no lendário{" "}
